# จดมิเตอร์ น้ำ-ไฟ — GitHub Pages Wrapper
...
4. เปิดลิงก์ GitHub Pages ที่ได้ บนมือถือ แล้วกด "Add to Home Screen" — จะได้ไอคอนจดมิเตอร์และเปิดแบบเต็มจอไม่มีแถบ URL ของ Google
...
- `icons/` — ไอคอนทุกขนาดที่สร้างจากรูปที่ให้มา (ตัดขอบพื้นหลังออกแล้ว): favicon, apple-touch-icon, icon-192, icon-512
